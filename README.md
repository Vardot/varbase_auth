[![pipeline status](https://git.drupalcode.org/project/varbase_auth/badges/9.2.x/pipeline.svg)](https://git.drupalcode.org/project/varbase_auth/-/pipelines)
[![Varbase Social Single Sign-On](https://img.shields.io/badge/Varbase%20Social%20Single%20Sign--On-9.2.0-0d6efc?labelColor=001d38&style=flat-square)](https://git.drupalcode.org/project/varbase_auth/-/pipelines?ref=9.2.0)
[![Automated Functional Testing](https://git.drupalcode.org/project/varbase_auth/badges/9.2.x/pipeline.svg)](https://git.drupalcode.org/project/varbase_auth/-/pipelines)
